...
// // ReviewDelete handles deleting a review by ID.
...
// // @Failure 500 {object} string "Server error"
// // @Security BearerAuth
// // @Router /provider/{id}/review/{id} [delete]
...
// 	id := &cp.ById{Id: c.Param("id")}
// 	_, err := h.srvs.Review.Delete(context.Background(), id)
// 	if err != nil {
// 		c.JSON(http.StatusInternalServerError, gin.H{"error": "Couldn't delete review", "details": err.Error()})
// 		return
// 	}
