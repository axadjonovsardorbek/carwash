...
INSERT INTO services (id, name, description, price, duration, created_at, updated_at, deleted_at) VALUES
...
('22b0d7f5-3c8b-54f2-08b4-82b3f2e3c3f2', 'Oil Change', 'Engine oil and filter replacement', 75000, 30, '2024-08-13 14:00:00.000000+05', '2024-08-13 14:00:00.000000+05', 0);

-- Providers table mock data
INSERT INTO providers (id, user_id, company_name, description, availability, average_rating, location, created_at, updated_at, deleted_at) VALUES
('47c7a789-73fe-4bba-87c8-7e75a1b642e4', '91cf6e44-d61a-4e81-8516-f906ef8c53f9', 'Car Care Inc.', 'Professional car care services', '09:00-18:00', 0.0, 'Downtown', '2024-08-13 13:39:43.540641+05', '2024-08-13 13:39:43.540641+05', 0);

-- Provider Services table mock data
INSERT INTO provider_services (id, user_id, service_id, provider_id, created_at, updated_at, deleted_at) VALUES
...
INSERT INTO bookings (id, user_id, provider_id, total_price, status, payment_method, created_at, updated_at, deleted_at) VALUES
...
INSERT INTO payments (id, user_id, booking_id, amount, status, payment_method, created_at, updated_at, deleted_at) VALUES
...
INSERT INTO reviews (id, booking_id, user_id, provider_id, rating, comment, created_at, updated_at, deleted_at) VALUES
